# 📍 SpotFinder — Eventos em Portugal

O **SpotFinder** é uma plataforma integrada de descoberta cultural que visa simplificar a forma como os cidadãos interagem com a oferta de lazer no país.
...
* **Valor Acrescentado:** Além do acesso facilitado a eventos em todas as localidades, a ferramenta foca-se na **eficiência**, ajudando os utilizadores a reduzir significativamente o tempo de pesquisa e filtragem de informação.
...
* **Arquitetura Técnica:**
    > `[Utilizador]` → `[Frontend (React)]` → `[Backend (API)]` → `[Base de Dados]`
